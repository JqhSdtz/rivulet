package org.laputa.rivulet.liquibase.diff;
 ...
 */
public class HibernateChangedForeignKeyChangeGenerator extends ChangedForeignKeyChangeGenerator {
    ...
    public Class<? extends DatabaseObject>[] runBeforeTypes() {
        return super.runBeforeTypes();
    }

    @Override
    public Class<? extends DatabaseObject>[] runAfterTypes() {
        return super.runAfterTypes();
    }

    @Override
    public Change[] fixChanged(DatabaseObject changedObject, ObjectDifferences differences, DiffOutputControl control, Database referenceDatabase, Database comparisonDatabase, ChangeGeneratorChain chain) {
        if (referenceDatabase instanceof RvDatabase || comparisonDatabase instanceof RvDatabase) {
