...
import org.hibernate.bytecode.enhance.spi.*;
...
//		}
    ...
    public MetadataImplementor metadata() {
        if (this.metadata == null) {
            this.metadata = RvMetadataBuildingProcess.complete(
                    managedResources,
                    metamodelBuilder.getBootstrapContext(),
